...
<html lang="en">
<head>
    <title>Edutools || Manage Notes</title>
    <!-- Google Web Fonts -->
...
{               ?>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-sm btn-primary" href="manage-notes.php?delid=<?php echo ($row->ID);?>"  onclick="return confirm('Do you really want to Delete ?');">Delete</a>
                                        <button class="btn btn-sm btn-primary" onclick="shareNote('<?php echo htmlentities($row->ID);?>')">Share</button>
                                    </td>
                                </tr><?php $cnt=$cnt+1;}} ?>
    ...
    <script>
        function shareNote(noteId) {
            const url = `https://yourwebsite.com/notes.php?id=${noteId}`;
