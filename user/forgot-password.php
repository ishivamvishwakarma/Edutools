...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Edutools || Forgot Password</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post" name="chngpwd" onSubmit="return valid();">
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" name="newpassword" class="form-control" placeholder="New Password" required="true" id="newpassword">
                                <label for="floatingInput">New Password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" name="confirmpassword" class="form-control" placeholder="Confirm Password" required="true" id="confirmpassword">
