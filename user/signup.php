...
<body>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <h1 class="text-primary">
                                    <img src="img/edu_logo.png" alt="logo" style="width: 70px; height: 70px; border-radius: 50%;">
                                    Edutools.io
                                </h1>
                        ...
                        <form method="post" onsubmit="return validateForm()">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="mobno" class="form-control" required="true" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits">
                            ...
                            <div class="form-floating mb-4">
                                <input type="password" value="" class="form-control" name="password" id="password" required="true">
    ...
    <script>
        ...
        function validateForm() {
            var mobno = document.querySelector('input[name="mobno"]').value;
            var isNumeric = /^\d{10}$/.test(mobno);
            if (!isNumeric) {
