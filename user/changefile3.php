                                        ...
                                        foreach ($results as $row) { ?>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="notestitle"
                                                    value="<?php echo htmlentities($row->NotesTitle); ?>" readonly='true'>


                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputEmail2" class="form-label">View Old file3</label>
                                                <a href="folder3/<?php echo $row->file3; ?>" width="100" height="100"
                                                    target="_blank"> <strong style="color: red">View Old File</strong></a>
